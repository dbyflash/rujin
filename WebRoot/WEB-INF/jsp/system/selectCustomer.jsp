...
<script type="text/javascript">
	...
	function search_collector(nodeid,type){
	    ...
	    $("#search_customer_list_box").datagrid({
		  url : "${ctx }/manager/customer/list.do?s_name="+encodeURI($("#s_name").val())
	   });
	}
	
	function savesearch_customer(idinput,nameinput){
	   var row = $("#search_customer_list_box").datagrid("getSelected"); 
	   if(row==null){
	       rightBottom("请选择客户");
	   }
      $("#"+idinput).val(row.id);
...
<div data-options="region:'center'" fit="true" border="false">
    <table id="search_customer_list_box"  class="easyui-datagrid"  
		                  ...
		                  <thead>
			               <tr>
			                <th data-options="field:'ck',checkbox:true"></th>
				             ...
				             <th data-options="field:'name',width:250,halign:'center',align:'left'">客户名称</th>
			              </tr>
		                </thead>
	  </table>
</div>
