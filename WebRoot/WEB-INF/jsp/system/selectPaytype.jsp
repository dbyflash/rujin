...
<script type="text/javascript">
	...
	function search_collector(nodeid,type){
	    ...
	    $("#search_paytype_list_box").datagrid({
		  url : "${ctx }/manager/paytype/list.do?s_name="+encodeURI($("#s_name").val())
	   });
	}
	
	function savesearch_paytype(idinput,nameinput){
	   var row = $("#search_paytype_list_box").datagrid("getSelected"); 
	   if(row==null){
	       rightBottom("请选择结算方式");
	   }
      $("#"+idinput).val(row.id);
...
<div data-options="region:'center'" fit="true" border="false">
    <table id="search_paytype_list_box"  class="easyui-datagrid"  
		                  ...
		                  <thead>
			               <tr>
			                <th data-options="field:'ck',checkbox:true"></th>
				             ...
				             <th data-options="field:'name',width:250,halign:'center',align:'left'">结算方式</th>
			              </tr>
		                </thead>
	  </table>
</div>
