...
public class MoneytypeController extends PerssoftController<Moneytype> {

	
	@Override
	public void index() {
		render("/WEB-INF/jsp/manager/moneytype/moneytypeList.jsp");
	}
	
	@Override
	public void create() {
		super.create();
		render("/WEB-INF/jsp/manager/moneytype/moneytypeForm.jsp");
	}
	...
	@Override
	public void list() {
		PageData<Moneytype> list=Moneytype.dao.pageList(getParaMap());
		renderJson(list);
	}
	public void getlist() {
		List<Moneytype> list=Moneytype.dao.getlist();
		renderJson(list);
	}
	@Override
	public void save() {
		...
		try {
			...
			Moneytype object = getModel(modelClass);
